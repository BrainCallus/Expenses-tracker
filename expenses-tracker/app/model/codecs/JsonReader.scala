...
object JsonReader {
  ...
  implicit val longReader: JsonReader[Long] = {
    case JsonLong(value) => Right(value)
    case _               => Left(WrongType("Long expected"))
  }
  ...
  implicit val dateTimeReader: JsonReader[LocalDateTime] = {
    case JsonDateTime(value) => Right(value)
    case _                   => Left(WrongType("LocalDate expected"))
  }
